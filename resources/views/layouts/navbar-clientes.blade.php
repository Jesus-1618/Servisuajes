            ...
            <div class="nav-bar col-auto col-md-3 col-xl-2 px-sm-2 px-0">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        <li class="nav-item">
                            <a href="{{route('homeAdministracion.create')}}" class="nav-link align-middle px-0">
                        ...
                        <li>
                            ...
                            <ul class="collapse nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                                ...
                                <li>
                                    <a href="{{route('registrarEmpresas.create')}}" class="nav-link px-0"> <span class="d-none d-sm-inline">Contactos</span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
